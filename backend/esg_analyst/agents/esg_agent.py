...
from backend.esg_analyst.services.sec_service import SECService
from backend.esg_analyst.services.audio_service import AudioService
from backend.esg_analyst.services.vector_db import SimpleVectorDB
from backend.esg_analyst.agents.prompts import CVUP_VS_ONEREPORT_PROMPT, FINAL_ESG_SYNTHESIS_PROMPT

class ESGAgent:
    def __init__(self):
        self.db = SimpleVectorDB(settings.esg_db_dir)
        self.client = None
